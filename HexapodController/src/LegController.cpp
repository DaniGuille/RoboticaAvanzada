...
{
    ::std::pair< const ::std::string*, const ::std::string*> r = ::std::equal_range(__RoboCompLegController__LegController_all, __RoboCompLegController__LegController_all + 8, current.operation);
    if(r.first == r.second)
    {
